    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Hai! aku Azka Fiali, dan situs web ini adalah tempat di mana aku berbagi tentang apapun yang menurutku menarik.Terima kasih telah mengunjungi dan semoga kamu menikmati konten di situs web ini!"</p>
                    </div>
                </div>
            </div>
        </main>
